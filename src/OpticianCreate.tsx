...
const validateFirstname: Validator[] = [
  required(),
  minLength(2),
  maxLength(100),
];
const validateLastname: Validator[] = [
  required(),
  minLength(2),
  maxLength(255),
];
...
const validatePostalCode: Validator[] = [
  ...
  regex(
    /^\d{4,5}$/,
    "Entrez un code postal valide (4 à 5 chiffres selon pays)"
  ),
];
...
const validateAdmin: Validator[] = [
  ...
  choices(
    ["0", "1"],
    "Préciser si cet utilisateur aura les droits administrateur ou non"
  ),
];
