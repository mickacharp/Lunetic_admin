import { Edit, ListProps, NumberInput, ReferenceInput, SelectInput, SimpleForm } from "react-admin";
...
export const ModelTempleColorEdit = (props: ListProps) => (
  <Edit {...props} actions={<PostEditActions />}>
    ...
    <SimpleForm>
      ...
      <ReferenceInput source="id_model" reference="models" label="Monture" fullWidth>
      ...
      <ReferenceInput source="id_color_model" reference="colors" label="Couleur" fullWidth>
        <SelectInput optionText={optionRendererColor} />
      </ReferenceInput>
      <ReferenceInput source="id_wishlist" reference="wishlists" label="Nom Wishlist" fullWidth>
